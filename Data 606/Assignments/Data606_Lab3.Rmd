...
Ans: Streak length of 1 means 1 shot made and next missed. Zero length mean the first shot was a miss.
...
Ans: The distribution is right skewed with a range of 0 to 4, and a mode of 0. The biggest streak was 0 shots.
...
Ans: There were 19 heads and 81 tail for the unfair coin.
...
Ans: We need to add probaility to the code.    
...
The distribution is right skewed similar to kobe. The typical streak also remained the same at 0. However here the longest streak is 10 shots compare to the 4 of kobe.  
```{r plot-streak-kobe1}
...
Ans: I would say somwhat similar distribution which is right skewed, however there we might not have such long streaks as the sample size is pretty small at 133 shots. 
...
Ans: the stimulated shots has a larger streaks compare to kobes. This actually goes against the hot hand model becasue kobe longesest streak was 4 where we considered the shots dependenet, however here the shots are independent but yet we have larger streak.
